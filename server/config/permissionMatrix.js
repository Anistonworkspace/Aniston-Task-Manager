...
const ROLE_PERMISSIONS = {
  ...
  manager: {
    users:            { view: true, create: true, edit: false, delete: false, manage: false },
    ...
    boards:           { view: true, create: true, edit: true, delete: true, manage_members: true, manage_settings: false, export: true },
    tasks:            { view: true, create: true, edit: true, delete: true, assign: true, change_status: true, comment: true, upload: true, approve: true },
    subtasks:         { view: true, create: true, edit: true, delete: true },
    task_comments:    { view: true, create: true, edit: true, delete: true },
    task_files:       { view: true, upload: true, delete: true },
  ...
  assistant_manager: {
    ...
    roles:            { view: false, manage: false },
    admin_settings:   { view: false, manage: false },
    workspaces:       { view: true, create: true, edit: true, delete: false, manage_members: false },
    boards:           { view: true, create: false, edit: false, delete: false, manage_members: false, manage_settings: false, export: true },
    tasks:            { view: true, create: true, edit: true, delete: false, assign: true, change_status: true, comment: true, upload: true, approve: false },
    subtasks:         { view: true, create: true, edit: true, delete: true },
    task_comments:    { view: true, create: true, edit: true, delete: false },
    task_files:       { view: true, upload: true, delete: false },
    labels:           { view: true, create: true, edit: false, delete: false },
    automations:      { view: true, create: false, edit: false, delete: false },
    dependencies:     { view: true, create: true, delete: false },
    dashboard:        { view: true, export: false },
    reports:          { view: true, export: false },
    exports:          { view: true, export: false },
