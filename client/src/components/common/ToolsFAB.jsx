...
export default function ToolsFAB({ onOpenVoiceNotes, onOpenFeedback, onOpenAI }) {
  ...
  return (
    <div className="fixed bottom-5 right-4 z-[9998] flex flex-col-reverse items-end gap-3">
      {/* Main FAB button */}
      <button
      ...
      <div className={`transition-all duration-300 ${expanded ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-4 scale-50 pointer-events-none'}`}
