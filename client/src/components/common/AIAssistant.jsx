  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div className={`bg-[var(--primary-background-color)] rounded-2xl shadow-2xl border border-border flex flex-col overflow-hidden h-full transition-all duration-300`}>
            {/* Header */}
